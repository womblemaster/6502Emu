...
void BOARD_MEM_CONFIG(){
	...
	memory[0xc00c]=0x04;  // 04 decimal into A
	...
	memory[0xc200]=0xbd;	 // LDA absolute,X - 3 bytes
	memory[0xc201]=0x00;
	memory[0xc202]=0xd0;	// 0xd000
	memory[0xc203]=0xe8;	// INX
	memory[0xc204]=0x60; // RTS - to Monitor
