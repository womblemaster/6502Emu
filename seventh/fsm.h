...
#include <string.h>
#include <stdlib.h>
#include <ncurses.h> // now needed for the display functions


// NCurses Windows
extern WINDOW *lcd_win, *lcd_border_win, *reg_win, *main_win;
